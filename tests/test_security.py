"""Tests: SSRF protection, private/loopback/metadata blocking, decompression bombs."""
...
from backlink_hunter_core.security import (
    ...
    SecurityError, validate_url_scheme_host, resolve_and_validate,

    safe_gzip_decompress, is_allowed_upload, safe_join,
